...
from paelladoc.domain.models.project import Bucket, DocumentStatus # Import enums from domain
...
class ProjectMemoryDB(SQLModel, table=True):
    ...
    objectives: Optional[List[str]] = Field(sa_column=Column(JSON), default=None) # Store list as JSON
